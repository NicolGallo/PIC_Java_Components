...
public class CoapServerGateway
{
	...
	private void initializeDefaultResources() {
		// UpdateSystemPerformanceResourceHandler instance
		...
		// UpdateTelemetryResourceHandler instance
		...
		// GetActuatorCommandResourceHandler instance
		GetActuatorCommandResourceHandler getActuatorCommandResourceHandler = new GetActuatorCommandResourceHandler(
				ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE.getResourceType());

		if (this.dataMsgListener != null) {
			this.dataMsgListener.setActuatorDataListener(null, getActuatorCommandResourceHandler);
		}

		addResource(ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE, null, getActuatorCommandResourceHandler);
	...
	private Resource createResourceChain(ResourceNameEnum resource) {return null;}
